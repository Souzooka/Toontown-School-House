...
import random
CountryClubId2Layouts = {ToontownGlobals.Zones.BossbotCountryClubIntA: (0, 1, 2),
 ToontownGlobals.Zones.BossbotCountryClubIntB: (3, 4, 5),
 ToontownGlobals.Zones.BossbotCountryClubIntC: (6, 7, 8)}
