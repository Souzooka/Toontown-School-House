...
__fishDict = {0: ((1,
     ...
     (1,
      1,
      4,
      (TTG.Zones.ToontownCentral, Anywhere)),
     (3,
      5,
      5,
      (TTG.Zones.PunchlinePlace, TTG.Zones.TheBrrrgh)),
     (3,
      5,
      3,
      (TTG.Zones.SillyStreet, TTG.Zones.DaisyGardens)),
     (1,
      5,
      2,
      (TTG.Zones.LoopyLane, TTG.Zones.ToontownCentral))),
 2: ((2,
      6,
      1,
      (TTG.Zones.DaisyGardens, Anywhere)),
     (2,
      6,
      9,
      (TTG.Zones.ElmStreet, TTG.Zones.DaisyGardens)),
     (5,
      11,
      4,
      (TTG.Zones.LullabyLane,)),
     (2,
      6,
      3,
      (TTG.Zones.DaisyGardens, TTG.Zones.MyEstate)),
     (5,
      11,
      2,
      (TTG.Zones.DonaldsDreamland, TTG.Zones.MyEstate))),
 4: ((2,
      8,
      1,
      (TTG.Zones.ToontownCentral, Anywhere)),
     ...
     (2,
      8,
      6,
      (TTG.Zones.ToontownCentral, TTG.Zones.MinniesMelodyland))),
 6: ((8,
      12,
      1,
      (TTG.Zones.TheBrrrgh,)),),
 8: ((1,
     ...
     (2,
      6,
      2,
      (TTG.Zones.MinniesMelodyland, Anywhere)),
     (5,
      10,
      5,
      (TTG.Zones.MinniesMelodyland, Anywhere)),
 ...
 12: ((7,
       15,
       1,
       (TTG.Zones.DonaldsDock, Anywhere)),
      (18,
       20,
       6,
       (TTG.Zones.DonaldsDock, TTG.Zones.MyEstate)),
      (1,
       5,
       5,
       (TTG.Zones.DonaldsDock, TTG.Zones.MyEstate)),
 ...
 14: ((2,
       6,
       1,
       (TTG.Zones.DaisyGardens, TTG.Zones.MyEstate, Anywhere)), (2,
       6,
       3,
       (TTG.Zones.DaisyGardens, TTG.Zones.MyEstate))),
 16: ((4,
       12,
       5,
       (TTG.Zones.MinniesMelodyland, Anywhere)), (4,
       12,
       7,
       (TTG.Zones.BaritoneBoulevard, TTG.Zones.MinniesMelodyland)), (4,
       12,
       8,
       (TTG.Zones.TenorTerrace, TTG.Zones.MinniesMelodyland))),
 18: ((2,
       4,
       3,
       (TTG.Zones.DonaldsDock, Anywhere)), (5,
       8,
       7,
       (TTG.Zones.TheBrrrgh,)), (4,
       6,
       8,
       (TTG.Zones.LighthouseLane,))),
 20: ((4,
       6,
       1,
       (TTG.Zones.DonaldsDreamland,)),
      (14,
       18,
       10,
       (TTG.Zones.DonaldsDreamland,)),
      ...
      (10,
       14,
       4,
       (TTG.Zones.DonaldsDreamland, TTG.Zones.DaisyGardens))),
 22: ((12,
       16,
       2,
       (TTG.Zones.MyEstate, TTG.Zones.DaisyGardens, Anywhere)),
      (14,
       18,
       3,
       (TTG.Zones.MyEstate, TTG.Zones.DaisyGardens, Anywhere)),
      (14,
       20,
       5,
       (TTG.Zones.MyEstate, TTG.Zones.DaisyGardens)),
      (14,
       20,
       7,
       (TTG.Zones.MyEstate, TTG.Zones.DaisyGardens))),
 24: ((9,
      ...
      (8,
       12,
       5,
       (TTG.Zones.DaisyGardens, TTG.Zones.DonaldsDock)),
      (8,
       12,
       6,
       (TTG.Zones.DaisyGardens, TTG.Zones.DonaldsDock)),
 ...
 26: ((10,
      ...
      (14,
       20,
       8,
       (TTG.Zones.SleetStreet, TTG.Zones.TheBrrrgh)),
      (16,
       20,
       10,
       (TTG.Zones.WalrusWay, TTG.Zones.TheBrrrgh))),
 28: ((2,
       10,
       2,
       (TTG.Zones.DonaldsDock, Anywhere)), (4,
       10,
       6,
       (TTG.Zones.BarnacleBoulevard, TTG.Zones.DonaldsDock)), (4,
       10,
       7,
       (TTG.Zones.SeaweedStreet, TTG.Zones.DonaldsDock))),
 30: ((13,
       17,
       5,
       (TTG.Zones.MinniesMelodyland, Anywhere)),
      (16,
       20,
       10,
       (TTG.Zones.AltoAvenue, TTG.Zones.MinniesMelodyland)),
      (12,
       18,
       9,
       (TTG.Zones.TenorTerrace, TTG.Zones.MinniesMelodyland)),
 ...
 32: ((1,
       5,
       2,
       (TTG.Zones.ToontownCentral, TTG.Zones.MyEstate, Anywhere)),
      (1,
       5,
       3,
       (TTG.Zones.TheBrrrgh, TTG.Zones.MyEstate, Anywhere)),
      (1,
       5,
       4,
       (TTG.Zones.DaisyGardens, TTG.Zones.MyEstate)),
      ...
      (1,
       5,
       10,
       (TTG.Zones.TheBrrrgh, TTG.Zones.DonaldsDreamland))),
 34: ((1,
       20,
       10,
       (TTG.Zones.DonaldsDreamland, Anywhere)),)}
...
def getValue(genus, species, weight):
    ...
    if hasattr(base, 'cr') and base.cr:
        if hasattr(base.cr, 'newsManager') and base.cr.newsManager:
            ...
            if ToontownGlobals.Holidays.JellyBeanFishingHoliday in holidayIds or ToontownGlobals.Holidays.JellyBeanFishingHolidayMonth in holidayIds:
                finalValue *= JellybeanFishingHolidayScoreMultiplier
    elif ToontownGlobals.Holidays.JellyBeanFishingHoliday in simbase.air.holidayManager.currentHolidays or ToontownGlobals.Holidays.JellyBeanFishingHolidayMonth in simbase.air.holidayManager.currentHolidays:
        finalValue *= JellybeanFishingHolidayScoreMultiplier
    return finalValue
