...
CameraStartingPosition = (-28,
 ...
 0,
 0)
GameDuration = {ToontownGlobals.Zones.ToontownCentral: 150,
 ToontownGlobals.Zones.DonaldsDock: 145,
 ToontownGlobals.Zones.DaisyGardens: 140,
 ToontownGlobals.Zones.MinniesMelodyland: 135,
 ToontownGlobals.Zones.TheBrrrgh: 130,
 ToontownGlobals.Zones.DonaldsDreamland: 125}
BaseBonusOnCompletion = {ToontownGlobals.Zones.ToontownCentral: 15,
 ToontownGlobals.Zones.DonaldsDock: 17,
 ToontownGlobals.Zones.DaisyGardens: 19,
 ToontownGlobals.Zones.MinniesMelodyland: 21,
 ToontownGlobals.Zones.TheBrrrgh: 23,
 ToontownGlobals.Zones.DonaldsDreamland: 25}
BonusPerSecondLeft = 0.8
ScoreLossPerEnemyCollision = {ToontownGlobals.Zones.ToontownCentral: -1,
...
ScoreLossPerFallDown = {ToontownGlobals.Zones.ToontownCentral: -0,
 ToontownGlobals.Zones.DonaldsDock: -0,
 ToontownGlobals.Zones.DaisyGardens: -0,
 ToontownGlobals.Zones.MinniesMelodyland: -0,
 ToontownGlobals.Zones.TheBrrrgh: -0,
 ToontownGlobals.Zones.DonaldsDreamland: -0}
ScoreLossPerStomperSquish = {ToontownGlobals.Zones.ToontownCentral: -1,
 ToontownGlobals.Zones.DonaldsDock: -1,
 ToontownGlobals.Zones.DaisyGardens: -1,
 ToontownGlobals.Zones.MinniesMelodyland: -1,
 ToontownGlobals.Zones.TheBrrrgh: -1,
 ToontownGlobals.Zones.DonaldsDreamland: -1}
SectionWeights = {ToontownGlobals.Zones.ToontownCentral: ((0, 25),
                                   (1, 25),
                                   (2, 25),
                                   (3, 15),
                                   (4, 10),
                                   (5, 0)),
 ToontownGlobals.Zones.DonaldsDock: ((0, 15),
                               (1, 25),
                               (2, 25),
                               (3, 15),
                               (4, 10),
                               (5, 10)),
 ToontownGlobals.Zones.DaisyGardens: ((0, 15),
                                (1, 15),
                                (2, 25),
                                (3, 25),
                                (4, 10),
                                (5, 10)),
 ToontownGlobals.Zones.MinniesMelodyland: ((0, 10),
                                     (1, 10),
                                     (2, 25),
                                     (3, 25),
                                     (4, 15),
                                     (5, 15)),
 ToontownGlobals.Zones.TheBrrrgh: ((0, 10),
                             (1, 10),
                             (2, 15),
                             (3, 25),
                             (4, 25),
                             (5, 15)),
 ToontownGlobals.Zones.DonaldsDreamland: ((0, 10),
                                    (1, 10),
                                    (2, 15),
                                    (3, 15),
                                    (4, 25),
                                    (5, 25))}
NumSections = {ToontownGlobals.Zones.ToontownCentral: 5,
 ToontownGlobals.Zones.DonaldsDock: 5,
 ToontownGlobals.Zones.DaisyGardens: 5,
 ToontownGlobals.Zones.MinniesMelodyland: 5,
 ToontownGlobals.Zones.TheBrrrgh: 5,
 ToontownGlobals.Zones.DonaldsDreamland: 5}
PercentMaxEnemies = {ToontownGlobals.Zones.ToontownCentral: 50,
 ToontownGlobals.Zones.DonaldsDock: 60,
 ToontownGlobals.Zones.DaisyGardens: 70,
 ToontownGlobals.Zones.MinniesMelodyland: 80,
 ToontownGlobals.Zones.TheBrrrgh: 90,
 ToontownGlobals.Zones.DonaldsDreamland: 100}
PercentMaxTreasures = {ToontownGlobals.Zones.ToontownCentral: 100,
 ToontownGlobals.Zones.DonaldsDock: 100,
 ToontownGlobals.Zones.DaisyGardens: 100,
 ToontownGlobals.Zones.MinniesMelodyland: 100,
 ToontownGlobals.Zones.TheBrrrgh: 100,
 ToontownGlobals.Zones.DonaldsDreamland: 100}
PercentMaxSpawnPoints = {ToontownGlobals.Zones.ToontownCentral: 100,
 ToontownGlobals.Zones.DonaldsDock: 90,
 ToontownGlobals.Zones.DaisyGardens: 80,
 ToontownGlobals.Zones.MinniesMelodyland: 70,
 ToontownGlobals.Zones.TheBrrrgh: 60,
 ToontownGlobals.Zones.DonaldsDreamland: 50}
PercentMaxStompers = {ToontownGlobals.Zones.ToontownCentral: 50,
 ToontownGlobals.Zones.DonaldsDock: 60,
 ToontownGlobals.Zones.DaisyGardens: 70,
 ToontownGlobals.Zones.MinniesMelodyland: 80,
 ToontownGlobals.Zones.TheBrrrgh: 90,
