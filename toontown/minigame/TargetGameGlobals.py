...
difficultyPatterns = {ToontownGlobals.Zones.ToontownCentral: [[8,
                                    4,
                                    2,
                                    0],
                                   [10,
                                   ...
                                   10,
                                   2],
 ToontownGlobals.Zones.DonaldsDock: [[7,
                                4,
                                2,
                                0],
                               [11,
 ...
 ToontownGlobals.Zones.DaisyGardens: [[6,
                                ...
                                8,
                                2],
 ToontownGlobals.Zones.MinniesMelodyland: [[6,
                                      4,
                                      2,
                                      0],
                                     [12,
                                     ...
                                     8,
                                     2],
 ToontownGlobals.Zones.TheBrrrgh: [[5,
                              4,
                              2,
                              0],
                             [12,
