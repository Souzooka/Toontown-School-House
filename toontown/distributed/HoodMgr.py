...
class HoodMgr(DirectObject.DirectObject):
    ...
    ToontownCentralTunnelDropPoints = ([-28.3,
     ...
     [30.488,
      ...
      0,
      0])
    dropPoints = {ToontownGlobals.Zones.DonaldsDock: ([-28.0,
                                    -2.5,
                                    5.8,
                                    120.0,
                                    0.0,
                                   ...
                                   [-38,
                                    ...
                                    -0.0,
                                    0.0]),
     ToontownGlobals.Zones.ToontownCentral: ([-60,
                                        -8,
                                        1.3,
                                        -90,
                                        0,
                                       ...
                                       [-130.7,
                                        ...
                                        0,
                                        0]),
     ToontownGlobals.Zones.TheBrrrgh: ([35,
                                  -32,
                                  6.2,
                                  138,
                                  0.0,
                                 ...
                                 [-116,
                                  ...
                                  0.0,
                                  0.0]),
     ToontownGlobals.Zones.MinniesMelodyland: ([86,
                                          44,
                                          -13.5,
                                          121.1,
                                          0.0,
     ...
     ToontownGlobals.Zones.DaisyGardens: ([0,
                                    ...
                                    [87,
                                     ...
                                     0.0,
                                     0.0]),
     ToontownGlobals.Zones.DonaldsDreamland: ([77,
                                         91,
                                         0.0,
                                         124.4,
                                         0.0,
                                        ...
                                        [76,
                                         ...
                                         0.0,
                                         0.0]),
     ToontownGlobals.Zones.GoofySpeedway: ([-0.7,
                                      62,
                                      0.08,
                                      182,
                                      0,
                                     ...
                                     [29,
                                      ...
                                      0,
                                      0]),
     ToontownGlobals.Zones.GolfZone: ([-49.6,
                                 102,
                                 0,
                                 162,
                                 0,
                                ...
                                [73,
                                 ...
                                 0,
                                 0]),
     ToontownGlobals.Zones.OutdoorZone: ([-165.8,
                                    108,
                                    0.025,
                                    252,
                                    0,
                                   ...
                                   [23,
                                    ...
                                    0,
                                    0]),
     ToontownGlobals.Zones.Tutorial: ([130.9,
                                 -8.6,
                                 -1.3,
                                 105.5,
                                 0,
                                 0],),
     ToontownGlobals.Zones.SellbotHQ: ([64,
                                  -128,
                                  0.26,
                                  36,
                                  0,
                                 ...
                                 [79,
                                  ...
                                  0,
                                  0]),
     ToontownGlobals.Zones.CashbotHQ: ([102,
                                  -437,
                                  -23.439,
                                  360,
                                  0,
                                 ...
                                 [132,
                                  ...
                                  0,
                                  0]),
     ToontownGlobals.Zones.LawbotHQ: ([77.5,
                                 129.13,
                                 -68.4,
                                 -166.6,
                                 0,
                                ...
                                [-20.16,
                                 ...
                                 0,
                                 0])}
    hoodName2Id = {'dd': ToontownGlobals.Zones.DonaldsDock,
     'tt': ToontownGlobals.Zones.ToontownCentral,
     'br': ToontownGlobals.Zones.TheBrrrgh,
     'mm': ToontownGlobals.Zones.MinniesMelodyland,
     'dg': ToontownGlobals.Zones.DaisyGardens,
     'oz': ToontownGlobals.Zones.OutdoorZone,
     'ff': ToontownGlobals.Zones.FunnyFarm,
     'gs': ToontownGlobals.Zones.GoofySpeedway,
     'dl': ToontownGlobals.Zones.DonaldsDreamland,
     'bosshq': ToontownGlobals.Zones.BossbotHQ,
     'sellhq': ToontownGlobals.Zones.SellbotHQ,
     'cashhq': ToontownGlobals.Zones.CashbotHQ,
     'lawhq': ToontownGlobals.Zones.LawbotHQ,
     'gz': ToontownGlobals.Zones.GolfZone}
    hoodId2Name = {ToontownGlobals.Zones.DonaldsDock: 'dd',
     ToontownGlobals.Zones.ToontownCentral: 'tt',
     ToontownGlobals.Zones.Tutorial: 'tt',
     ToontownGlobals.Zones.TheBrrrgh: 'br',
     ToontownGlobals.Zones.MinniesMelodyland: 'mm',
     ToontownGlobals.Zones.DaisyGardens: 'dg',
     ToontownGlobals.Zones.OutdoorZone: 'oz',
     ToontownGlobals.Zones.FunnyFarm: 'ff',
     ToontownGlobals.Zones.GoofySpeedway: 'gs',
     ToontownGlobals.Zones.DonaldsDreamland: 'dl',
     ToontownGlobals.Zones.BossbotHQ: 'bosshq',
     ToontownGlobals.Zones.SellbotHQ: 'sellhq',
     ToontownGlobals.Zones.CashbotHQ: 'cashhq',
     ToontownGlobals.Zones.LawbotHQ: 'lawhq',
     ToontownGlobals.Zones.GolfZone: 'gz'}
    DefaultDropPoint = [0,
     0,
     0,
     0,
