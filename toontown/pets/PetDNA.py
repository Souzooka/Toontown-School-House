...
PetRarities2 = (('leopard', 0.005),
 ...
 ('tummy', 0.525),
 ('threeStripe', 1.0))
PetRarities = {'body': {ToontownGlobals.Zones.ToontownCentral: {'threeStripe': 50,
                                            'tummy': 30,
                                            'dots': 20},
          ToontownGlobals.Zones.DonaldsDock: {'threeStripe': 35,
                                        'tummy': 30,
                                        'dots': 20,
                                        'tigerStripe': 15},
          ToontownGlobals.Zones.DaisyGardens: {'threeStripe': 15,
                                         'tummy': 20,
                                         'dots': 20,
                                         'tigerStripe': 20,
                                         'turtle': 15},
          ToontownGlobals.Zones.MinniesMelodyland: {'threeStripe': 10,
                                              'tummy': 15,
                                              'dots': 30,
                                              'tigerStripe': 25,
                                              'turtle': 20},
          ToontownGlobals.Zones.TheBrrrgh: {'threeStripe': 5,
                                      'tummy': 10,
                                      'dots': 20,
                                      'tigerStripe': 25,
                                      'turtle': 25,
                                      'giraffe': 15},
          ToontownGlobals.Zones.DonaldsDreamland: {'threeStripe': 5,
                                             'tummy': 5,
                                             'dots': 15,
                                             'tigerStripe': 20,
                                             'turtle': 25,
...
def getRandomPetDNA(zoneId = ToontownGlobals.Zones.DonaldsDreamland):
