...
class PetTraits:
    ...
    class StdIncDistrib(TraitDistribution):
        ...
        Sz2MinMax = {ToontownGlobals.Zones.ToontownCentral: (0.2, 0.65),
         ToontownGlobals.Zones.DonaldsDock: (0.3, 0.7),
         ToontownGlobals.Zones.DaisyGardens: (0.4, 0.75),
         ToontownGlobals.Zones.MinniesMelodyland: (0.5, 0.8),
         ToontownGlobals.Zones.TheBrrrgh: (0.6, 0.85),
         ToontownGlobals.Zones.DonaldsDreamland: (0.7, 0.9)}

    class StdDecDistrib(TraitDistribution):
        TraitType = TraitDistribution.TraitTypes.DECREASING
        Sz2MinMax = {ToontownGlobals.Zones.ToontownCentral: (0.35, 0.8),
         ToontownGlobals.Zones.DonaldsDock: (0.3, 0.7),
         ToontownGlobals.Zones.DaisyGardens: (0.25, 0.6),
         ToontownGlobals.Zones.MinniesMelodyland: (0.2, 0.5),
         ToontownGlobals.Zones.TheBrrrgh: (0.15, 0.4),
         ToontownGlobals.Zones.DonaldsDreamland: (0.1, 0.3)}

    class ForgetfulnessDistrib(TraitDistribution):
        TraitType = TraitDistribution.TraitTypes.DECREASING
        Sz2MinMax = {ToontownGlobals.Zones.ToontownCentral: (0.0, 1.0),
         ToontownGlobals.Zones.DonaldsDock: (0.0, 0.9),
         ToontownGlobals.Zones.DaisyGardens: (0.0, 0.8),
         ToontownGlobals.Zones.MinniesMelodyland: (0.0, 0.7),
         ToontownGlobals.Zones.TheBrrrgh: (0.0, 0.6),
         ToontownGlobals.Zones.DonaldsDreamland: (0.0, 0.5)}
