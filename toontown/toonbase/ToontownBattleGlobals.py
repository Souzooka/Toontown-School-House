...
Levels = [
    [0, 20, 200, 800, 2000, 6000, regMaxSkill],
    [0, 20, 100, 800, 2000, 6000, regMaxSkill],
    [0, 20, 100, 800, 2000, 6000, regMaxSkill],
    [0, 40, 200, 1000, 2500, 7500, regMaxSkill],
...
ToonAttackTarget = PythonUtil.Enum("Single, Group")
AvPropTargetCat = ((ToonAttackTarget.Single,
  ToonAttackTarget.Group,
  ToonAttackTarget.Single,
  ToonAttackTarget.Group,
  ToonAttackTarget.Single,
  ToonAttackTarget.Group,
  ToonAttackTarget.Group),
