...
SuitAttackTarget = PythonUtil.Enum("Unknown, Single, Group")
SuitAttacks = {'Audit': ('phone', SuitAttackTarget.Single),
 'Bite': ('throw-paper', SuitAttackTarget.Single),
 'BounceCheck': ('throw-paper', SuitAttackTarget.Single),
 'BrainStorm': ('effort', SuitAttackTarget.Single),
 'BuzzWord': ('speak', SuitAttackTarget.Single),
 'Calculate': ('phone', SuitAttackTarget.Single),
 'Canned': ('throw-paper', SuitAttackTarget.Single),
 'Chomp': ('throw-paper', SuitAttackTarget.Single),
 'CigarSmoke': ('cigar-smoke', SuitAttackTarget.Single),
 'ClipOnTie': ('throw-paper', SuitAttackTarget.Single),
 'Crunch': ('throw-object', SuitAttackTarget.Single),
 'Demotion': ('magic1', SuitAttackTarget.Single),
 'DoubleTalk': ('speak', SuitAttackTarget.Single),
 'Downsize': ('magic2', SuitAttackTarget.Single),
 'EvictionNotice': ('throw-paper', SuitAttackTarget.Single),
 'EvilEye': ('glower', SuitAttackTarget.Single),
 'Filibuster': ('speak', SuitAttackTarget.Single),
 'FillWithLead': ('pencil-sharpener', SuitAttackTarget.Single),
 'FingerWag': ('finger-wag', SuitAttackTarget.Single),
 'Fired': ('magic2', SuitAttackTarget.Single),
 'FiveOClockShadow': ('glower', SuitAttackTarget.Single),
 'FloodTheMarket': ('glower', SuitAttackTarget.Single),
 'FountainPen': ('pen-squirt', SuitAttackTarget.Single),
 'FreezeAssets': ('glower', SuitAttackTarget.Single),
 'Gavel': ('gavel', SuitAttackTarget.Single),
 'GlowerPower': ('glower', SuitAttackTarget.Single),
 'GuiltTrip': ('magic1', SuitAttackTarget.Group),
 'HalfWindsor': ('throw-paper', SuitAttackTarget.Single),
 'HangUp': ('phone', SuitAttackTarget.Single),
 'HeadShrink': ('magic1', SuitAttackTarget.Single),
 'HotAir': ('speak', SuitAttackTarget.Single),
 'Jargon': ('speak', SuitAttackTarget.Single),
 'Legalese': ('speak', SuitAttackTarget.Single),
 'Liquidate': ('magic1', SuitAttackTarget.Single),
 'MarketCrash': ('throw-paper', SuitAttackTarget.Single),
 'MumboJumbo': ('speak', SuitAttackTarget.Single),
 'ParadigmShift': ('magic2', SuitAttackTarget.Group),
 'PeckingOrder': ('throw-object', SuitAttackTarget.Single),
 'PickPocket': ('pickpocket', SuitAttackTarget.Single),
 'PinkSlip': ('throw-paper', SuitAttackTarget.Single),
 'PlayHardball': ('throw-paper', SuitAttackTarget.Single),
 'PoundKey': ('phone', SuitAttackTarget.Single),
 'PowerTie': ('throw-paper', SuitAttackTarget.Single),
 'PowerTrip': ('magic1', SuitAttackTarget.Group),
 'Quake': ('quick-jump', SuitAttackTarget.Group),
 'RazzleDazzle': ('smile', SuitAttackTarget.Single),
 'RedTape': ('throw-object', SuitAttackTarget.Single),
 'ReOrg': ('magic3', SuitAttackTarget.Single),
 'RestrainingOrder': ('throw-paper', SuitAttackTarget.Single),
 'Rolodex': ('roll-o-dex', SuitAttackTarget.Single),
 'RubberStamp': ('rubber-stamp', SuitAttackTarget.Single),
 'RubOut': ('hold-eraser', SuitAttackTarget.Single),
 'Sacked': ('throw-paper', SuitAttackTarget.Single),
 'SandTrap': ('golf-club-swing', SuitAttackTarget.Single),
 'Schmooze': ('speak', SuitAttackTarget.Single),
 'Shake': ('stomp', SuitAttackTarget.Group),
 'Shred': ('shredder', SuitAttackTarget.Single),
 'SongAndDance': ('song-and-dance', SuitAttackTarget.Single),
 'Spin': ('magic3', SuitAttackTarget.Single),
 'Synergy': ('magic3', SuitAttackTarget.Group),
 'Tabulate': ('phone', SuitAttackTarget.Single),
 'TeeOff': ('golf-club-swing', SuitAttackTarget.Single),
 'ThrowBook': ('throw-object', SuitAttackTarget.Single),
 'Tremor': ('stomp', SuitAttackTarget.Group),
 'Watercooler': ('watercooler', SuitAttackTarget.Single),
 'Withdrawal': ('magic1', SuitAttackTarget.Single),
 'WriteOff': ('hold-pencil', SuitAttackTarget.Single)}
