...
class GZHood(ToonHood.ToonHood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.holidayStorageDNADict = {Holidays.HalloweenProps: ['phase_6/dna/halloween_props_storage_GZ.dna'],
         Holidays.SpookyProps: ['phase_6/dna/halloween_props_storage_GZ.dna']}
