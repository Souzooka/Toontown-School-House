...
class DGHood(ToonHood.ToonHood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.holidayStorageDNADict = {Holidays.WinterDecorations: ['phase_8/dna/winter_storage_DG.dna'],
         Holidays.WackyWinterDecorations: ['phase_8/dna/winter_storage_DG.dna'],
         Holidays.HalloweenProps: ['phase_8/dna/halloween_props_storage_DG.dna'],
         Holidays.SpookyProps: ['phase_8/dna/halloween_props_storage_DG.dna']}
