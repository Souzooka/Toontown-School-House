...
class DistributedSuitPlannerAI(DistributedObjectAI.DistributedObjectAI, SuitPlannerBase.SuitPlannerBase):
    ...
    def requestBattle(self, zoneId, suit, toonId):
        ...
        if simbase.config.GetBool('props-buff-battles', True) and canonicalZoneId in self.cellToGagBonusDict:
            ...
            trackToHolidayDict = {ToontownBattleGlobals.SQUIRT_TRACK: ToontownGlobals.Holidays.HydrantsBuffBattles, ToontownBattleGlobals.THROW_TRACK: ToontownGlobals.Holidays.MailboxesBuffBattles, ToontownBattleGlobals.HEAL_TRACK: ToontownGlobals.Holidays.TrashcansBuffBattles}
