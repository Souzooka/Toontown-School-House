...
baseScheme = {'TI_wainscotting': wainscottingBase,
 ...
 'TI_door': doorBase,
 'TI_floor': floorBase}
colors = {Zones.DonaldsDock: {'TI_wainscotting': wainscottingBase,
               'TI_wallpaper': wallpaperBase,
               'TI_wallpaper_border': wallpaperBorderBase,
               'TI_door': doorBase,
               'TI_floor': floorBase},
 Zones.ToontownCentral: {'TI_wainscotting': wainscottingBase,
                   'TI_wallpaper': wallpaperBase,
                   'TI_wallpaper_border': wallpaperBorderBase,
                   'TI_door': doorBase + [Vec4(0.8, 0.5, 0.3, 1.0)],
                   'TI_floor': floorBase},
 Zones.TheBrrrgh: baseScheme,
 Zones.MinniesMelodyland: baseScheme,
 Zones.DaisyGardens: baseScheme,
 Zones.GoofySpeedway: baseScheme,
 Zones.DonaldsDreamland: {'TI_wainscotting': wainscottingBase,
                    'TI_wallpaper': wallpaperBase,
                    'TI_wallpaper_border': wallpaperBorderBase,
                    'TI_door': doorBase,
                    'TI_floor': floorBase},
 Zones.Tutorial: {'TI_wainscotting': wainscottingBase,
            'TI_wallpaper': wallpaperBase,
            'TI_wallpaper_border': wallpaperBorderBase,
            'TI_door': doorBase + [Vec4(0.8, 0.5, 0.3, 1.0)],
            'TI_floor': floorBase},
 Zones.MyEstate: baseScheme}
